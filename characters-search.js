const showCorrespondingHeros = () => {
    ...
    const name = document.getElementById("search-character").value;
  ...
  function character() {
      ...
      let urlQueryParameters = new URLSearchParams(window.location.search),
        ...
        name = document.getElementById("search-character").value.trim();
     
      if (queryParameterName !== null && queryParameterName !== "") {
        document.getElementById("search-character").value = queryParameterName;
        connection();
